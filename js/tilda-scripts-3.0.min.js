...
function t_loadJsFile(t, e) {
    if (document.querySelector('script[src^="' + t + '"]')) e && e();
        ...
        n.type = "text/javascript", n.src = t, e && n.addEventListener("load", e), n.addEventListener("error", (function (t) {
...
function t_loadCSSFile(t, e) {
    if (document.querySelector('link[href^="' + t + '"]')) e && e();
        ...
        n.rel = "stylesheet", n.type = "text/css", n.media = "all", n.href = t, n.crossOrigin = "anonymous", e && n.addEventListener("load", e), n.addEventListener("error", (function (t) {
...
function t_smoothScrollTo(t, e) {
    ...
    function l() {
        var d = performance.now(),
            s = Math.min((d - r) / e, 1),
            c = a(s);
        window.scrollTo(0, i + o * c), s < 1 ? requestAnimationFrame(l) : (n.removeAttribute("data-scroll"), n.removeAttribute("data-scrollable"), window.scrollTo(0, t))
    }
    ...
    function () {
        ...
        function e() {
            ...
            for (var n = 0; n < h.length; n++) {
                var i, o;
                (o = (i = h[n]).style).height.indexOf("vh") > -1 && (e = parseInt(o.height) / 100, d = m + "px", o.height = d)
            }
        }
